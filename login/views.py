...
def send_email(email, code):
    ...
    subject = "来自DeanTong的网站注册邮件确认"
    text_content = '''感谢注册该网站，谢谢支持，请持续关注！\
                   果你看到这条消息，说明你的邮箱服务器不提供HTML链接功能，请联系管理员！'''
    html_content = '''
...
def user_confirm(request):
    ...
    a = c_time + datetime.timedelta(settings.CONFIRM_DAYS)
    if now > a:
        confirm.user.delete()
